## YOLOV7：You Only Look Once目标检测模型在keras当中的实现
---
...
## Top News
**`2022-09`**:**仓库创建，支持step、cos学习率下降法、支持adam、sgd优化器选择、支持学习率根据batch_size自适应调整、新增图片裁剪、支持多GPU训练、支持各个种类目标数量计算、支持heatmap。**  
...
| :-----: | :-----: | :------: | :------: | :------: | :-----: |
| COCO-Train2017 | [yolov7_weights.h5](https://github.com/bubbliiiing/yolov7-keras/releases/download/v1.0/yolov7_weights.h5) | COCO-Val2017 | 640x640 | 50.7 | 69.2
| COCO-Train2017 | [yolov7_x_weights.h5](https://github.com/bubbliiiing/yolov7-keras/releases/download/v1.0/yolov7_x_weights.h5) | COCO-Val2017 | 640x640 | 52.4 | 70.5
